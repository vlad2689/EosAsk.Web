...
export class AnswersClient {
    ...
    postAnswer(postAnswerDto: PostAnswerDTO): Promise<AnswerDTO | null> {
        let url_ = this.baseUrl + "/api/answers";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processPostAnswer(response: Response): Promise<AnswerDTO | null> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    markCreatedOnBlockchain(answerId: number | undefined): Promise<AnswerDTO | null> {
        let url_ = this.baseUrl + "/api/answers/markCreatedOnBlockchain?";
        if (answerId === null)
            throw new Error("The parameter 'answerId' cannot be null.");
        else if (answerId !== undefined)
            url_ += "answerId=" + encodeURIComponent("" + answerId) + "&"; 
    ...
    markBadAnswer(answerId: number | undefined): Promise<AnswerDTO | null> {
        let url_ = this.baseUrl + "/api/answers/markBadAnswer?";
        if (answerId === null)
            throw new Error("The parameter 'answerId' cannot be null.");
        else if (answerId !== undefined)
            url_ += "answerId=" + encodeURIComponent("" + answerId) + "&"; 
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMarkBadAnswer(_response);
        });
    }

    protected processMarkBadAnswer(response: Response): Promise<AnswerDTO | null> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class BountiesClient {
    ...
    markAwarded(bountyId: number | undefined, answerId: number | undefined): Promise<BountyDTO | null> {
        let url_ = this.baseUrl + "/api/bounties/markAwarded?";
        if (bountyId === null)
            throw new Error("The parameter 'bountyId' cannot be null.");
        else if (bountyId !== undefined)
            url_ += "bountyId=" + encodeURIComponent("" + bountyId) + "&"; 
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMarkAwarded(_response);
        });
    }

    protected processMarkAwarded(response: Response): Promise<BountyDTO | null> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class CheckLoginClient {
    ...
    getLoginStatus(): Promise<UserDTO | null> {
        let url_ = this.baseUrl + "/api/checklogin/getLoginStatus";
        url_ = url_.replace(/[?&]$/, "");
    ...
    logout(): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/checklogin/logout";
        url_ = url_.replace(/[?&]$/, "");
